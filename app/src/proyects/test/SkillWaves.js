class SkillWaves {
  ...
  loop() {
    ...
    this.drawSine(200, this.t, 25, 40, 8, 1, 'Python');
    this.drawSine(250, this.t, 18, 30, 10, 0, 'HTML');
    this.drawSine(300, this.t, 20, 25, 4, 0, 'CSS');
    this.drawSine(350, this.t, 30, 20, 10, 0, 'JavaScript');
  }
